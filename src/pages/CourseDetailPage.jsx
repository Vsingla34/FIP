            ...
            <div style={{position:'sticky',top:'88px'}}>
              <div style={{background:'#fff',border:'2px solid var(--border)',borderRadius:'var(--radius-lg)',overflow:'hidden',boxShadow:'0 8px 32px rgba(0,0,0,0.08)'}}>
                ...
                <div style={{padding:'20px 24px'}}>
                  ...
                  {enrolled ? (
                    <div style={{background:'var(--green)',borderRadius:'10px',padding:'14px',textAlign:'center',color:'#fff'}}>
                      <i className="fa-solid fa-circle-check" style={{fontSize:'20px',display:'block',marginBottom:'6px'}}></i>
                      <div style={{fontWeight:700,fontSize:'14px'}}>You're Registered!</div>
                      <div style={{fontSize:'12px',marginTop:'3px',opacity:.8}}>Check your email for the Zoom link</div>
                    </div>
                  ) : isPast ? (
